...
public class DES {
    ...
    /** For Android App Usage purposes
     * 
     */
    ...
    /**
     * This method convert String to hexadecimal.
     * @author yeesum
     * @param str
     * @return
     */
    ...
    /**
     * This method convert hexadecimal into String(ASCII).
     * @author yeesum
     * @param hex
     * @return
     */
	public static String convertHexToString(String hex){
		...
		for( int i = 0; i < hex.length() - 1; i += 2 ){
			...
			returnString.append((char)decimal);
   ...
   /**
    * concatCount is a variable that declared to track how many 0s is append to the string, after the decryption will based on this value
    * to delete the 0s and convert back the hexadecimal into string(original message).
    */
	private static int concatCount = 0;
	
	public static int getConcatCount(){
		return concatCount;
	}
	
	 /**
	  * This method append 0s to the hexadecimal which not more than 16bits. For each set of hexadecimal contains 16bits, if it is not, 
	  * append 0s at the back of the string.
     * @author yeesum
     * @param hex
     * @return
     */
    public static String appendZero(String hex){
    	if((hex.length()%16) < 16){
			...
			for(int i = hex.length()%16; i < 16; i ++){
    ...
    /**
     * Check whether the result of decryption is match with the original string, return true if it is, false otherwise.
     * @author yeesum
     * @param plaintext
     * @param decryptionResult
     * @return
     */
    public static boolean checkStringMatch(String plaintext, String decryptionResult){
    	
    	if(plaintext.equals(decryptionResult)){
    		return true;
    ...
    public static void writeFile(String EncryptTime, String DecryptTime){
		try {
	    	File file = new File("C:/Users/alienware-sum/Desktop/test2.txt");
			...
			bw.write(EncryptTime);
			bw.newLine();
			
			bw.write(DecryptTime);
			bw.newLine();
			bw.newLine();
    ...
    public static byte[] decryptCBC(byte[] ciphertext, byte[] key) {
        ...
        progressTotal = ciphertext.length;
